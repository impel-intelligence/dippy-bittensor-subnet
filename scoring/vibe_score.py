...
def OLDcalculate_vibe_match_score(
    model_name: str,
    revision: str,
    contexts: List[Any],
    last_user_messages: List[Any],
    expected_outputs: List[Any],
    override_utilization: bool = False,
    verbose: bool = False,
):
    ...
    model = LLM(
        ...
        gpu_memory_utilization=VLLM_GPU_MEMORY if not override_utilization else 1.0,
...
def OLDget_vibe_match_score(request: EvaluateModelRequest):
    try:
