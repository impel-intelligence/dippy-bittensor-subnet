...
./../$VENV_NAME/bin/python3 validation_api.py --main-api-port $VALIDATION_API_PORT --eval-score-port $EVAL_SCORE_API_PORT --vibe-score-port $VIBE_SCORE_API_PORT >> "log/validation_api_${BATCH_NUM}.log" 2>&1 &
